...
namespace Crm.Migrations
{
    ...
    [Migration("20260227201734_AddedSLAEntities")]
    partial class AddedSLAEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crm.Activities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Crm.Contacts.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Crm.CustomerNotes.CustomerNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCustomerNotes", (string)null);
                });

            modelBuilder.Entity("Crm.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Crm.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Crm.Positions.Position", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Crm.Support.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSupportTickets", (string)null);
                });
            ...
            modelBuilder.Entity("Crm.Activities.Activity", b =>
                {
                    b.HasOne("Crm.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Crm.Employees.Employee", b =>
                {
                    b.HasOne("Crm.Positions.Position", null)
                        .WithMany()
