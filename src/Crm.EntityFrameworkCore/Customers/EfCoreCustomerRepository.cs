...
namespace Crm.Customers
{
        ...
        : EfCoreRepository<CrmDbContext, Customer, Guid>(dbContextProvider), ICustomerRepository
    {
        ...
        protected virtual IQueryable<Customer> ApplyDataFilters(IQueryable<Customer> query, string? name = null, string? surname = null, string? email = null, string? phone = null, string? address = null, string? companyName = null, EnumCustomer? customerType = null)
        {
            query
